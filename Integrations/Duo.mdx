  ...
  <Step title="Step 2">
    **Generate Admin API Credentials**
    ...
    6. ![images/Duo3.png](/images/Duo3.png)
       ...
       In the Details section, copy the **Integration Key (ikey)** – Identifies your app, **Secret Key (skey)** – A secure credential, and **API Hostname** – URL to interact with Duo.
