...
<Check>
  **Set up a new **[**GitHub**](https://github.com/join)** account**:

  - It is requested to create a new [GitHub](https://github.com/join) account, as a new GitHub account can be created so that existing organization users are unaffected.
</Check>
