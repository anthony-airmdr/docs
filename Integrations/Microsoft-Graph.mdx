...
<Steps>
  ...
  <Step title="Securely share the Client Secret, Client and Tenant IDs to AirMDR">
    To access the Client ID, and Tenant ID to use in Graph API authentication
    ...
    7. Now, your **Tenant ID** and \*\*Client ID \*\*are copied and ready to use for authentication in Microsoft Graph API.
