...
<Steps>
  ...
  <Step title="Securely share .json and email ID">
    <Check>
      <Icon icon="envelope" /> Share the .json file and the generated **admin_email_id **via a secured method with the AirMDR operations team or self-configure in the AirMDR Integrations Dashboard.
    </Check>
  </Step>
</Steps>
