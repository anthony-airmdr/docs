...
<Steps>
  ...
  <Step title="Create a New Service User - Viewer Access">
    ...
    10. Use the **Copy API Token**  option at the bottom to copy the API Token.
...
<Info>
 ...
 6. In the left pane, select the required pages (e.g., Endpoints, Endpoint Threats, Access Settings, Accounts, Activity) and the required permissions for the respective page in the right pane for the New Role and click **Save**.\
    ![Sentinel One13 Pn](/images/SentinelOne13.png)
 7. In the left navigation pane, select **Service Users**.\
    ![Sentinel One2 Pn](/images/SentinelOne2.png)
 8. In the **Actions** drop-down list, click on **Create New Service User**.

    ![Sentinel One3 Pn](/images/SentinelOne3.png)
 9. Provide the mandatory fields and click **Next**
...
11. Allow access to your site under "**Select Scope of Access**". 
12. Set access to "**AirMDR Actions**" (select the custom role defined with pages and permissions).
...
14. Use the **Copy API Token** option at the bottom to copy the API Token.
