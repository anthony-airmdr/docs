...
<Steps>
  <Step title="Access Rapid7 Insight Platform">
    ...
    4. Choose the Type of API Key (User Key or Organization Key) to Generate:
       ...
       - **Organization Key:** Represents the entire organization with comprehensive access across all products. Only platform or organization administrators can generate an Organization Key.
    5. Click **Generate**.
       - For a **User Key**:​
