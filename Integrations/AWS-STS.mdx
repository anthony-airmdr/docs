...
<Steps>
  ...
  <Step title="Review and Create the Role">
    1. Provide the required information in the **Role details** and the **Description** (Optional) for the role.
    ...
    2. Review your selections (Permissions and Policies), and if everything is correct.
       ...
       - **Review Trust Policy** – If using cross-account access or service, verify the trust policy.
    3. Click **Create Role**.
  </Step>
