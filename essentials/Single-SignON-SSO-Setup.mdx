...
* The **Usage** tab provides all the required credentials (SAML Protocol Configuration Parameters).image

### Set up and configure Okta SSO in AirMDR UI

* Login into the AirMDR UI.

* On the bottom left, click on the **User** and select **Go to Admin dashboard**.image

* Select the Organization for which SSO has to be set up.

* Under the **SSO SETTINGS** tab, click **Edit**.image

* In the **Setup SSO** dropdown list, select **Yes, New Config**.image
